...
async function getSchedule({
    ...
    return(
        <>
<h2 className="display-5 text-center"><u>Class Schedule For The Day</u></h2>
...
<div class="accordion-item mt-4">
    <h2 class="accordion-header" id="headingOne">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target={`#collapseOne${session.id}`} aria-expanded="true" aria-controls={`collapseOne${session.id}`} value={session.id} onClick={(e)=>handleClick(e)}>
